        ...
        <Card>
          <CardContent className="p-5">
            <p className="flex items-center gap-2 text-xs font-medium uppercase tracking-wider text-muted-foreground">
              <CheckCircle2 className="size-4 text-tool-rotation" />{" "}
                ...
                <div className="flex flex-wrap gap-2">
                  {data.recommended_next.map((c) => (
                    <Link
                      ...
                      className="group inline-flex items-center gap-1 rounded-full border border-tool-rotation/25 bg-tool-rotation/5 px-3 py-1 text-sm font-medium text-tool-rotation transition-colors hover:bg-tool-rotation/12"
                    >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {data.avoid_next.length > 0 ? (
                data.avoid_next.map((c) => (
                  <span
                    key={c.crop}
                    className="inline-flex items-center rounded-full border border-destructive/20 bg-destructive/5 px-3 py-1 text-sm font-medium text-destructive"
                  >
                    {tCrop(c.crop, c.display)}
                  </span>
                ))
